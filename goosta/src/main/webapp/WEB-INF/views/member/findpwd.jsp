        ...
        <div class="loginArea clx">
            ...
            <fieldset>
              ...
              <div class="loginForm">
                ...
                <div class="formBox mt05">
                  <div class="speech type02" id="speechTypeEmail_6"></div>
                  <label for="memberMail_1" class="layerLabel">아이디</label><input type="text" id="memberMail_1" class="inputType01" name="email1Address" onkeydown="javascript:if(event.keyCode==13){findId('findIdType1Form');}" title="이메일 입력">
                </div>
              </div>
