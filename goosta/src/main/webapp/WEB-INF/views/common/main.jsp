...
<head>
	...
	<link href="resources/css/main/flexslider.css" rel="stylesheet" type="text/css" />
	<link href="resources/css/main/prettyPhoto.css" rel="stylesheet" type="text/css" />
	<link href="resources/css/main/animate.css" rel="stylesheet" type="text/css" media="all" />
    <link href="resources/css/main/owl.carousel.css" rel="stylesheet">
	...
	<script src="resources/js/main/jquery.prettyPhoto.js" type="text/javascript"></script>
	<script src="resources/js/main/jquery.nicescroll.min.js" type="text/javascript"></script>
	<script src="resources/js/main/superfish.min.js" type="text/javascript"></script>
	<script src="resources/js/main/jquery.flexslider-min.js" type="text/javascript"></script>
	<script src="resources/js/main/owl.carousel.js" type="text/javascript"></script>
	<script src="resources/js/main/animate.js" type="text/javascript"></script>
	<script src="resources/js/main/jquery.BlackAndWhite.js"></script>
	<script src="resources/js/main/myscript.js" type="text/javascript"></script>
...
<!-- PRELOADER -->
<img id="preloader" src="resources/images/preloader.gif" alt="" />
<!-- //PRELOADER -->
<div class="preloader_hide">
	...
	<!-- HEADER -->	
		...
		<section id="home" class="padbot0">
			...
			<div id="carousel">
				<ul class="slides">
					<li><img src="./resources/css/main/slider/slide1_bg.jpg" alt="" /></li>
					<li><img src="./resources/css/main/slider/slide2_bg.jpg" alt="" /></li>
					<li><img src="./resources/css/main/slider/slide3_bg.jpg" alt="" /></li>
				</ul>
			</div><!-- //TOP SLIDER -->
		</section><!-- //HOME -->
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-5 col-md-5 col-sm-5 ipad_img_in" data-appear-top-offset="-200" data-animated="fadeInRight">
							<img class="ipad_img1" src="resources/images/img1.png" alt="" />
						</div>
					</div><!-- //ROW -->
				</div><!-- //CONTAINER -->
			</div><!-- //MULTI PURPOSE -->
				...
				<div class="container" data-appear-top-offset="-200" data-animated="fadeInUp">
					...
					<div class="row">
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="resources/images/clients/1.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="resources/images/clients/2.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="resources/images/clients/3.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="resources/images/clients/4.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="resources/images/clients/5.jpg" alt="" />
						</div>
						<div class="col-lg-2 col-md-2 col-sm-2 client_img">
							<img src="resources/images/clients/6.jpg" alt="" />
						</div>
					</div><!-- //ROW -->
				</div><!-- CONTAINER -->
			</div><!-- //OUR CLIENTS -->
				...
				<div class="row" data-appear-top-offset="-200" data-animated="fadeInUp">
					...
					<div class="owl-demo owl-carousel team_slider">
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="resources/images/team/5.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>Jim Moss</p>
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="resources/images/team/6.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>John Marks</p>
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="resources/images/team/7.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>Joe Mades</p>
						...
						<div class="item">
							<div class="crewman_item">
								<div class="crewman">
									<img src="resources/images/team/8.jpg" alt="" />
								</div>
								<div class="crewman_descr center">
									<div class="crewman_descr_cont">
										<p>Julia Anderson</p>
